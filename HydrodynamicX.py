...
try:
    ...
    os.system('python -m pip install discord --upgrade')
    os.system('python -m pip install python-dotenv --upgrade')
    os.system('python -m pip install py-cord --upgrade')
    os.system('python -m pip install pycord --upgrade')
